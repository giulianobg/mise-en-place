package sb.mep.client.resources;
...
public class ClientEventResource extends BaseResouce {

	public ClientEventResource() {
...
//		mapper = new ObjectMapper();
	...
	@GET
	public SimplePageView fetch() {
		List<Event> events = Daos.get(EventDao.class).findAll();
		
		SimplePageView page = new SimplePageView("event.ftl");
		page.addParam("events", events);
	...
	@GET
	@Path("new")
	public SimplePageView editNew() {
		SimplePageView page = new SimplePageView("event-new.ftl");
		return page;
	}
	
	@GET
	@Path("search")
	public SimplePageView search(@QueryParam("q") String q) {
		return null;
	}
